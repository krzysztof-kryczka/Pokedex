...
export const PokemonInfo = ({ pokemon, isAuthenticated, toggleFavorite, isFavorite }) => (
   <div className="flex flex-col">
      ...
      {isAuthenticated && (
         <PokemonActions isAuthenticated={isAuthenticated} toggleFavorite={toggleFavorite} isFavorite={isFavorite} />
      )}
   </div>
)
